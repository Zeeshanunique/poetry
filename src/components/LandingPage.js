  ...
  return (
    <div className="landing-page">
      <nav className="navbar">
        ...
        <button className={`menu-toggle ${isMobile ? 'visible' : ''}`} onClick={toggleMenu}>
          {isMenuOpen ? '✕' : '☰'}
        </button>
        <ul className={`nav-links ${isMobile ? (isMenuOpen ? 'mobile open' : 'mobile') : ''}`}>
          <li><a href="#features" onClick={() => isMobile && toggleMenu()}>Features</a></li>
          <li><a href="#description" onClick={() => isMobile && toggleMenu()}>Description</a></li>
          <li><a href="#testimonials" onClick={() => isMobile && toggleMenu()}>Testimonials</a></li>
